(() => {
  ...
  const TOOL_VERSION = "0.4.1-pilot";
  const REQUEST_SCHEMA = "district-math-worksheet-builder-request/0.4";
  const CONTRACT_VERSION = "district-math-worksheet-builder/0.8-pilot";
