...
- Tools/Physics_Notes_Image_Toolkit.zip
...
4B must recompute the same content-stable Bank fingerprint used by 4A with the bundled ~stable_bank_fingerprint_v1.py. Harmless rezipping must not invalidate the Notes Map. Legacy raw-ZIP sha256 fingerprints fail closed and require one fresh 4A run.
